...
robocopy "EFCore.BulkExtensions" "EFCore.BulkExtensions.PerProvider\EFCore.BulkExtensions.PostgreSql" /E /XF "EFCore.BulkExtensions.csproj" "*.png" /XD "bin" "obj" "SqlAdapters"
...
robocopy "EFCore.BulkExtensions" "EFCore.BulkExtensions.PerProvider\EFCore.BulkExtensions.Sqlite" /E /XF "EFCore.BulkExtensions.csproj" "*.png" /XD "bin" "obj" "SqlAdapters"
...
robocopy "EFCore.BulkExtensions" "EFCore.BulkExtensions.PerProvider\EFCore.BulkExtensions.SqlServer" /E /XF "EFCore.BulkExtensions.csproj" "*.png" /XD "bin" "obj" "SqlAdapters"
