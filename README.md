...
If using UpdateByProperties and also having Identity column then that Id property should be [Excluded](https://github.com/borisdj/EFCore.BulkExtensions/issues/131).<br>
