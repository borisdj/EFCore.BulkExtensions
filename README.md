...
[Spatial](https://docs.microsoft.com/en-us/sql/relational-databases/spatial/spatial-data-types-overview?view=sql-server-ver15) types, like Geometry, are also supported and when Entity has one it Skips ClauseExistsExcept because it is not comparable.<br>
