...
robocopy "EFCore.BulkExtensions" "EFCore.BulkExtensions.MySql " /E /XF "*.csproj" "*.png" /XD "bin" "obj" "SqlAdapters"
...
robocopy "EFCore.BulkExtensions" "EFCore.BulkExtensions.PostgreSql" /E /XF "EFCore.BulkExtensions.csproj" "*.png" /XD "bin" "obj" "SqlAdapters"
...
robocopy "EFCore.BulkExtensions" "EFCore.BulkExtensions.Sqlite" /E /XF "EFCore.BulkExtensions.csproj" "*.png" /XD "bin" "obj" "SqlAdapters"
...
robocopy "EFCore.BulkExtensions" "EFCore.BulkExtensions.SqlServer" /E /XF "EFCore.BulkExtensions.csproj" "*.png" /XD "bin" "obj" "SqlAdapters"
