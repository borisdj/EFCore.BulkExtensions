...
#pragma warning disable CS1591 // No XML comments required here.
    ...
    public static TableInfo CreateInstance<T>(
        DbContext context,
        Type? type, 
        IList<T> entities, 
    ...
    #region SqlCommands
    public async Task<bool> CheckTableExistAsync(DbContext context, TableInfo tableInfo, bool isAsync, CancellationToken cancellationToken)
    {
        if (isAsync)
        {
    ...
    public static string GetUniquePropertyValues(object entity, List<string> propertiesNames, Dictionary<string, FastProperty> fastPropertyDict)
    {
        ...
        string delimiter = "_"; // TODO: Consider making it Configurable
