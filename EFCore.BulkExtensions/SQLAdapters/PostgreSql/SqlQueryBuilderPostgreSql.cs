...
public static class SqlQueryBuilderPostgreSql
{
    ...
    /// <param name="tableInfo"></param>
    /// <returns></returns>
    public static string CountUniqueConstraints(TableInfo tableInfo)
    {
    ...
    /// <param name="tableInfo"></param>
    /// <returns></returns>
    public static string CreateUniqueConstraint(TableInfo tableInfo)
    {
        var tableName = tableInfo.TableName;
        var schemaFormated = tableInfo.Schema == null ? "" : $@"""{tableInfo.Schema}"".";
        var fullTableNameFormated = $@"{schemaFormated}""{tableName}""";
    ...
    /// <param name="tableInfo"></param>
    /// <returns></returns>
    public static string DropUniqueConstraint(TableInfo tableInfo)
    {
        var tableName = tableInfo.TableName;
        var schemaFormated = tableInfo.Schema == null ? "" : $@"""{tableInfo.Schema}"".";
        var fullTableNameFormated = $@"{schemaFormated}""{tableName}""";
