...
/// <summary>
/// Contains a compilation of methods used in EFCore.
/// </summary>
public static class SqlQueryBuilder
{
    ...
    /// <returns></returns>
    public static string CreateTableCopy(
    ...
    {
        List<string> columnsNames = tableInfo.OutputPropertyColumnNamesDict.Values?.ToList() ?? new();
    ...
    public static (string sql, IEnumerable<object> parameters) MergeTable<T>(
        DbContext? context,
        TableInfo tableInfo, 
    ...
    /// <returns></returns>
    public static string GetCommaSeparatedColumns(
    ...
    /// <param name="propertColumnsNamesDict"></param>
    /// <returns></returns>
    public static string GetANDSeparatedColumns(
        List<string> columnsNames, 
        string? prefixTable = null, 
        string? equalsTable = null, 
