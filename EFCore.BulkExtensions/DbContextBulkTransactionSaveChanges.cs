...
internal static class DbContextBulkTransactionSaveChanges
{
    ...
    private static async Task InvokeBulkMethod(
        DbContext context,
    ...
    {
#pragma warning disable CS8618 // No XML comments required here
        public BulkMethodEntries()
#pragma warning restore CS8618 // No XML comments required here
        {
